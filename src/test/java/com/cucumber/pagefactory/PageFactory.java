...
public class PageFactory {
	...
	static {
		getClassInPackage(new com.cucumber.utilities.PropertiesFile()
				.getproperties("page.packages"));
	}
		...
		try {
			...
			if (packageName != null) {
				...
				page = (BasePage) Class.forName(pageClassFullName)
						.newInstance();
				//taking full path of file n create new instance of page
				//example ,page = new LoginPage();
